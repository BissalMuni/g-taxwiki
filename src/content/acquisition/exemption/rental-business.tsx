...
export default function RentalBusinessV10() {
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-bold mb-4">임대사업자 감면신청시</h1>
      ...
      <SectionNav sections={[
      { id: "구비서류", label: "구비서류" },
      { id: "취득세감면", label: "취득세 감면" },
      { id: "재산세감면", label: "재산세 감면" },
      { id: "매각말소처리", label: "매각·말소 처리" },
      { id: "제도개편", label: "제도 개편" },
      { id: "추징확인", label: "추징 확인" },
      { id: "연혁", label: "연혁" },
      { id: "관련법령", label: "관련 법령" }
      ...
      <CalcBox title="■ 임대감면후 매각 또는 말소시 처리방법" id="매각말소처리">

        <SubSection title="● 취득세 추징">
        ...
        <SubSection title="● 재산세 추징 (§31 ⑤ · §31의3 ⑤)">
        ...
        <SubSection title="● §31 추가 감면 — 공공주택사업자 외">
      ...
      <CalcBox title="■ (구)임대등록주택 제도 개편 현황" id="제도개편">
      ...
      <CalcBox title="■ 추징대상 확인방법" id="추징확인">

        <SubSection title="● 조회 방법">
      ...
      <CalcBox title="■ 임대주택 관련법 연혁" id="연혁">
      ...
      <CalcBox title="■ 관련 법령" id="관련법령">
        ...
        <SubSection title="● 공통 피참조 조문 (§31·§31의3 양쪽 인용)">
        ...
        <SubSection title="● §31 전용 — 공공주택 특별법 계열">
        ...
        <SubSection title="● §31의3 전용 — 민간임대주택에 관한 특별법 계열">
